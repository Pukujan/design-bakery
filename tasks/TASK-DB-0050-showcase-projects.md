...
- **Project data** (`frontend/src/app/portfolios/endtoend-engineer/engineering/projects.json`): appended ids 8–11 after the existing seven cards. Existing order is unchanged, so Study OS stays first. With 4 cards per carousel page, Fluffy V4 is on page 2 and the three ongoing repos are on page 3.
...
- Open questions for the owner:
  - card ordering: should Fluffy or the ongoing cards move earlier than page 2/3?
