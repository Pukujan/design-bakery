...
| apex `design-bakery.com/research/papers/db-r-2026-010` (Host override) | 307 text/plain, 15 B → `https://www.design-bakery.com/research/papers/db-r-2026-010` | 307 → same |
